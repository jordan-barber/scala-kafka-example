...
object App extends AppConfig with DefaultJsonProtocol {
  def main(args: Array[String]): Unit = {
    ...
    val bootstrapServers: String = "http://localhost:9092"
    ...
    val future: Future[Done] =
      Source
        ...
        .map { elem =>
          new ProducerRecord[String, String]("test", elem) //: Kafka ProducerRecord
        }
